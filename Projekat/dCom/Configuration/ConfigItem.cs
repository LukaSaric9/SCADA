...
namespace dCom.Configuration
{
    internal class ConfigItem : IConfigItem
	{
		...
		private int acquisitionInterval;  //10. kolona u txt fajlu -> na koliko sekundi zelimo da procitamo vrednosti automatski (# ako nije definisano-> stavimo koliko zelimo)
